...
| 1.1    | 02/05/2024 | -Ybañez Esquerre, Miguel Angel <br> -Quilla Luyo, Jorge Gerardo <br>-Avellaneda Ramos, Carlos Edward<br>-Ticona Luque, Rony Piero | se realizaron correciones de las Users Stories y la implementación de un sprint 2 para el desarrollo de la web app |
...
| - | - | - |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Miguel Angel Ybañez Esquerre** <br> ***TB1:*** Participación en el desarrollo del Sprint 1, Source Code Managment y el correcto desarrollo de los repositorios de GitHub, como el manejo de ramas, creación de la organización y merge<br> <br> ***TP:*** Desarrollo de componente solicitudes, como el manejo de ramas, creación de la organización y merge. <br> <br> ***TB2:*** <br> En esta parte del proyecto he podido diseñar un apartado para recepcionar los datos que los perfiles para dar muestra de una avance del proyecto.<br> ***TF:*** <br>En esta parte final del proyecto se logro se logro consolidar lo aprendido en la parte del backend de crear nuevos endpoints. <br> **Quilla Luyo Jorge Gerardo** <br> ***TB1:*** Desarrollo del capítulo 1 del informe y entrevista <br> <br> ***TP:*** Desarrollo del componente contacto de la pagina. <br> <br> ***TB2:***  <br> En esta parte del proyecto se creo los endpoint para la autentificación y project. <br> ***TF:*** <br> En la parte final del proyecto se logro poner en practica la consolidacion de los endpoint con el frontend <br> **Carlos Edward Avellaneda Ramos** <br> ***TB1:*** Capitulo 4 del informe asi como la landing page y base de datos, se hizo la entrevista a 3 ingenieros<br> <br> ***TP:*** Desarrollo de componente Gestionar proyecto. <br> <br> ***TB2:*** <br>En esta parte del proyecto he podido diseñar un apartado para recepcionar los datos de los polos con su base de datos. <br> ***TF:*** <br> En el desarrollo del proyecto se logro conectar la parte del backend con la del frontend <br> **Rony Piero Ticona Luque**<br>***TB1:*** Desarrollo del capítulo 2 del informe y entrevista <br> <br>***TP:*** Desarrollo del componente home <br> <br> ***TB2:***  <br> En esta parte del proyecto se creo los endpoint para parte de message y se creo la tabla en el backend. <br> ***TF:*** <br> En esta parte final del proyecto se dio la oportunidad de crear nuevos endpoint y juntarlo con la base de datos <br>| ***TB1:*** Las responsabilidades fueron asignadas de manera individual para que cada miembro se enfocara en un área específica del trabajo. Una vez asignadas, todos completamos nuestras respectivas tareas de manera exitosa. Al concluir, cada integrante del equipo pudo expresar sus ideas de forma efectiva durante las comunicaciones verbales. <br> ***TP:*** Las responsabilidades fueron asignadas de manera individual para que cada miembro se enfocara en un área específica del proyecto web. Una vez asignadas, todos completamos nuestras respectivas tareas de manera exitosa y se realizaron entregas individuales por medio de la plataforma Github. Al concluir, cada integrante del equipo pudo expresar sus ideas de forma efectiva durante las comunicaciones verbales. <br> ***TB2:*** En esta etapa del proyecto, el equipo trabajó en la creación y configuración de diversos endpoints necesarios para las funcionalidades de la aplicación. Cada miembro fue responsable de un aspecto específico, lo que permitió una colaboración efectiva y un progreso significativo. Se diseñaron apartados para recepcionar y gestionar datos, así como para autenticar usuarios y manejar proyectos. Además, se integraron bases de datos y se aseguraron de que todos los componentes estuvieran correctamente conectados entre el frontend y el backend. Las entrevistas y la recopilación de información de expertos fueron fundamentales para mejorar el diseño y la implementación de las soluciones propuestas.<br> ***TF:*** En la fase final del proyecto, se consolidaron los conocimientos adquiridos a lo largo del desarrollo. Se logró la integración completa del backend con el frontend, permitiendo una operación fluida y coherente de la aplicación. Los nuevos endpoints creados se unieron efectivamente con las bases de datos y se aseguraron de que todas las funcionalidades estuvieran alineadas con los requisitos del proyecto. Cada integrante del equipo tuvo la oportunidad de poner en práctica sus habilidades técnicas y de comunicación, lo que resultó en un producto final cohesionado y funcional. La colaboración y el manejo eficiente del código a través de GitHub fueron esenciales para el éxito del proyecto.| 
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | ***Miguel Angel Ybañez Esquerre*** <br> ***TB1:*** Se analizaron las convenciones de codigo para el correcto desarrollo de features, landing page y proximamente el web app <br> <br> ***TP:*** Desarrollo de componentes, merge de la plataforma y realizar informe de trabajo parcial. <br> <br> ***TB2:*** <br> Se creo endpoint para los perfiles del proyecto. <br> ***TF:*** <br> Se culmino el proyecto juntando los boundcontext y la parte de frontend y backend, <br> ***Quilla Luyo Jorge Gerardo*** <br> ***TB1:*** Análisis de entrevista y cambios en las ramas. <br> <br> ***TP:*** Desarrollos de wireflow, userflow diseño de la plataforma. <br> <br> ***TB2:*** <br> Se creo endpoint para los autentificación y projects los cuales se agregaron en swagger. <br> ***TF:*** <br> En la parte final se juntaron las vistas del fronte con la estructura del backend. <br> ***Carlos Edward Avellaneda Ramos*** <br> ***TB1:*** Análisis de entrevista y manejo del landing page. <br> <br> ***TP:*** Desarrollo de sieño de la plataforma y modelado. <br> <br> ***TB2:*** <br>Se creo endpoint para los los polos los cuales se agregaron en swagger y en mysql.<br> ***TF:*** <br> En el proyecto se logro culminar las pruebas y validaciones con el proyecto ya realizado por completo. <br> ***Rony Piero Ticona Luque*** <br> ***TB1:*** Análisis de competencia, análisis de entrevista, user personas, journey mapping y empathy mapping. <br> <br> ***TP:*** Desarrollo de informe y diseño de la plataforma. <br> <br> ***TB2:***<br> Se creo endpoint para message el cuales se agregaro en swagger y en mysql. <br> ***TF:*** <br> En esta parte del proyecto se logro mejorar los endpoint y ver el las conexiones del front junto al backend. <br> | ***TB1:*** Durante este sprint, cada integrante del equipo se dedicó al desarrollo de los elementos designados para esta entrega. Posteriormente, cada uno comunicó sus contribuciones de manera formal y por escrito, asegurando así una presentación coherente y efectiva de nuestros avances. <br>  ***TP:*** Durante este sprint2, cada integrante del equipo se dedicó al desarrollo de los componentes de la pagina web y elementos designados para esta entrega. Posteriormente, cada uno comunicó sus contribuciones de manera formal y por escrito, asegurando así una presentación coherente y efectiva de nuestros avances. <br> ***TB2:*** Durante esta etapa del proyecto, cada miembro del equipo se concentró en el desarrollo y la implementación de los endpoints necesarios para diversas funcionalidades de la aplicación. Se crearon endpoints específicos para perfiles, autenticación, proyectos y mensajes, los cuales se documentaron y agregaron en Swagger y MySQL para asegurar su correcto funcionamiento y accesibilidad. Los informes parciales fueron elaborados detallando cada avance, permitiendo así una comunicación clara y objetiva sobre el progreso realizado. La documentación escrita fue esencial para mantener una presentación coherente de los resultados obtenidos y para facilitar la colaboración entre los miembros del equipo y con otros interesados en el proyecto. <br> ***TF:*** En la fase final del proyecto, el equipo consolidó los diferentes componentes desarrollados, logrando una integración efectiva entre el frontend y el backend. Los endpoints fueron mejorados y validados, garantizando su correcto funcionamiento en conjunto con la interfaz de usuario. Las pruebas y validaciones se realizaron exhaustivamente, asegurando la calidad y coherencia del producto final. La documentación escrita de las conclusiones y resultados permitió una comunicación efectiva con todos los niveles jerárquicos y especialidades, destacando el éxito del proyecto y las habilidades técnicas y de coordinación del equipo.|
...
- [Capítulo V: Product Implementation, Validation \& Deployment](#capítulo-v-product-implementation-validation--deployment-1)
  ...
  - [5.4. Video About-The-Product](#54-video-about-the-product)
    ...
    - [Video Exposicion Final](#video-exposicion-final)
...
![Cliente-Perfil](images/web-application-wifreframes/Wireframe-Cliente-Perfil.png)

![Cliente-Proyectos](images/web-application-wifreframes/Wireframe-Cliente-Proyectos.png)

![Cliente-Explorar](images/web-application-wifreframes/Wireframe-Cliente-Explorar.png)

![Cliente-Ver-detalles](images/web-application-wifreframes/Wireframe-Cliente-Ver%20detalles%20de%20empresa.png)

![Cliente-Enviar solicitud](images/web-application-wifreframes/Wireframe-Cliente-Enviar%20solicitud%20a%20empresa.png)

![Cliente-Dashboard](images/web-application-wifreframes/Wireframe-Cliente-Dashboard.png)

![Cliente-Contacto](images/web-application-wifreframes/Wireframe-Cliente-Contacto.png)

**Segmento: Empresas de instalación de postes**

![Empresa-Inicio](images/web-application-wifreframes/Wrieframe-Emrpesa-Inicio.png)

![Empresa-Perfil](images/web-application-wifreframes/Wireframe-Empresa-Perfil.png)

![Empresa-Proyectos](images/web-application-wifreframes/Wireframe-Empresa-Proyectos.png)

![Empresa-Gestionar](images/web-application-wifreframes/Wireframe-Empresa-Gestionar%20proyecto.png)

![Empresa-Ver-solicitudes](images/web-application-wifreframes/Wireframe-Empresa-Ver%20solicitudes.png)

![Empresa-Ver-adjuntos](images/web-application-wifreframes/Wireframe-Empresa-Ver%20adjuntos%20de%20solicitud.png)

![Empresa-ver-detalles-empresa](images/web-application-wifreframes/Wireframe-Empresa-Ver%20detalles%20de%20solicitud.png)

![Empresa-contacto](images/web-application-wifreframes/Wireframe-Empresa-Contacto.png)

### 4.4.2. Web Applications Wireflow Diagrams

![Iniciar-sesion](images/wireflow-diagrams/WireFlow%20Iniciar%20Sesion.jpg)
...
![WireFlow-Cliente-Perfil](images/wireflow-diagrams/WireFlow%20Usuario_%20Cliente%20-%20Ver%20Perfil.jpg)
...
![WireFlow-Empresa-Perfil](images/wireflow-diagrams/WireFlow%20Usuario_%20Empresa%20-%20Ver%20Perfil.jpg)
...
![Cliente-proyectos](images/web-application-mockups/Cliente%20-%20Proyectos.png)

![Cliente-explorar](images/web-application-mockups/Cliente%20-%20Explorar%20empresas.png)

![Cliente-ver-detalles](images/web-application-mockups/Cliente%20-%20Ver%20detalles%20de%20emrpesa.png)

![Cliente-enviar-solicitud](images/web-application-mockups/Cleinte%20-%20Enviar%20solicitud%20a%20empresa.png)

![Cliente-contacto](images/web-application-mockups/Cliente%20-%20Contacto.png)
...
![Empresa-inicio](images/web-application-mockups/Empresa%20-%20Inicio.png)

![Empresa-perfil](images/web-application-mockups/Empresa-%20perfil.png)

![Empresa-proyectos](images/web-application-mockups/Empresa%20-%20Proyectos.png)
...
![Empresa-ver-detalles-de-solicitud](images/web-application-mockups/Empresa%20-%20ver%20detalles%20de%20solicitud.png)
